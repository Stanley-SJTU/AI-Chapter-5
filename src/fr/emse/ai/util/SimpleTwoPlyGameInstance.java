...
public class SimpleTwoPlyGameInstance {
    ...
    public static void main(String[] args) {
        ...
        SimpleTwoPlyGameTree<Integer> subtree1 =
                new SimpleTwoPlyGameTree<Integer>(Integer.MAX_VALUE,false,sublist1);  // now the value is not set
        ...
        SimpleTwoPlyGameTree<Integer> tree1 =
                new SimpleTwoPlyGameTree<Integer>(Integer.MIN_VALUE,true);
        tree1.addChild(subtree1);
        tree1.addChild(subtree2);
        tree1.addChild(subtree3);

        int minimaxTree = SimpleMinimaxOnTree.minimax(tree1);
